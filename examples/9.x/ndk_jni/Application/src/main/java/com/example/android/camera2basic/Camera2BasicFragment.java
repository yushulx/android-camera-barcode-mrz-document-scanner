...
public class Camera2BasicFragment extends Fragment
    ...
    private static final int MSG_UPDATE_TEXTVIEW = 0;
    private static final SparseLongArray SHUTTER_SPEED = new SparseLongArray();
    private volatile long mShutterSpeed = 1000000000 / 100;
    private BarcodeReader mBarcodeReader;
    private ToneGenerator mToneGenerator;
    static {
        SHUTTER_SPEED.append(0, 1000000000 / 1000);
        SHUTTER_SPEED.append(1, 1000000000 / 500);
        SHUTTER_SPEED.append(2, 1000000000 / 250);
        SHUTTER_SPEED.append(3, 1000000000 / 125);
        SHUTTER_SPEED.append(4, 1000000000 / 100);
    }
    static {
...
//            buffer.get(bytes);
            ...
            String timecost = " " + (SystemClock.currentThreadTimeMillis() - start) + " ms";
            image.close();
            try {
//                TextResult[] results = mBarcodeReader.decodeBuffer(bytes, mImageReader.getWidth(), mImageReader.getHeight(), nRowStride * nPixelStride, EnumImagePixelFormat.IPF_NV21, "");
    ...
    static {
        System.loadLibrary("dynamsoft_barcode");
    }
    ...
    public static class SimpleResult {
        ...
        public SimpleResult(String format, String text) {
            this.barcodeFormatString = format;
