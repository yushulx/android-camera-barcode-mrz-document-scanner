...
public final class StillImageActivity extends AppCompatActivity {
  ...
  private static final String GOOGLE_BARCODE_SCANNING = "Google Barcode Scanning";
  private static final String DYNAMSOFT_BARCODE_SCANNING = "Dynamsoft Barcode Scanning";
  ...
  private String selectedMode = GOOGLE_BARCODE_SCANNING;
  ...
  private void populateFeatureSelector() {
    ...
    options.add(GOOGLE_BARCODE_SCANNING);
    options.add(DYNAMSOFT_BARCODE_SCANNING);
  ...
  private void createImageProcessor() {
    ...
    try {
      switch (selectedMode) {
        case GOOGLE_BARCODE_SCANNING:
          imageProcessor = new BarcodeScannerProcessor(this);
          break;
        case DYNAMSOFT_BARCODE_SCANNING:
          imageProcessor = new DynamsoftBarcodeProcessor(this);
          break;
        default:
