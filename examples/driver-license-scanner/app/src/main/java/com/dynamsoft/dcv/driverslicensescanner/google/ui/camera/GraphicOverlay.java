 ...
 * properties. The
 * idea is that detection items are expressed in terms of a preview size, but
 * need to be scaled up
 * to the full view size, and also mirrored in the case of the front-facing
 * camera.
 * <p>
 *
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
     ...
     * graphics element. Add instances to the overlay using
    ...
    public static abstract class Graphic {
         ...
         * <li>{@link Graphic#translateX(float)} and {@link Graphic#translateY(float)}
         * adjust the
         * coordinate from the preview's coordinate system to the view coordinate
         * system.</li>
         * </ol>
         *
        ...
        /**
         * Adjusts a horizontal value of the supplied value from the preview scale to
         * the view
         * scale.
         */
        ...
        /**
         * Adjusts a vertical value of the supplied value from the preview scale to the
         * view scale.
         */
        ...
        /**
         * Adjusts the y coordinate from the preview's coordinate system to the view
         * coordinate
         * system.
         */
    ...
    /**
     * Sets the camera attributes for size and facing direction, which informs how
     * to transform
