 ...
 * really be used for
 * any type of item). This is used to receive newly detected items, add a
 * graphical representation
 * to an overlay, update the graphics as the item changes, and remove the
 * graphics when the item
 * goes away.
 */
public class BarcodeGraphicTracker extends Tracker<Barcode> {
    ...
    /**
     * Consume the item instance detected from an Activity or Fragment level by
     * implementing the
     ...
     * happen for
     * intermediate frames temporarily, for example if the object was momentarily
     * blocked from
     * view.
     */
    @Override
