...
/**
 * Factory for creating a tracker and associated graphic to be associated with a
 * new barcode. The
 * multi-processor uses this factory to create barcode trackers as needed -- one
 * for each barcode.
 */
class BarcodeTrackerFactory implements MultiProcessor.Factory<Barcode> {
    private GraphicOverlay<BarcodeGraphic> mGraphicOverlay;
    private BarcodeGraphicTracker.BarcodeUpdateListener mListener;
